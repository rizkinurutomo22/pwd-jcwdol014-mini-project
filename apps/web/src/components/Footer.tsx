  ...
  return (
    <footer className="bg-white px-10 pb-6 pt-10 md:px-20">
      <div className="mx-auto mb-10 flex flex-wrap justify-between">
        <div className="xl:1/2 mb-8 w-full pr-8 md:mb-0 md:w-1/3 lg:w-1/3">
        ...
        <div className="mb-8 w-full pr-8 md:w-1/3 lg:w-1/3">
          <h3 className="mb-4 text-xl font-semibold text-black">Payments</h3>
          <div className="flex gap-4">
            <button className="rounded-md bg-slate-200 p-2 text-black hover:bg-white">
              Pay 1
            </button>
            <button className="rounded-md bg-slate-200 p-2 text-black hover:bg-white">
              Pay 2
        ...
        <div className="w-full md:w-1/3 lg:w-1/3">
          ...
          <form className="mb-6">
            ...
            <button
              type="submit"
              className="mt-2 w-full rounded-md bg-purple-600 px-4 py-2 text-white hover:bg-purple-500"
            >
              Subscribe
            </button>
          </form>
